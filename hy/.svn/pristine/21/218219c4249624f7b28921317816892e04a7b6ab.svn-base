	...
	$('.agreeCtr .allAgr').each(function () {
		$(this).click(function (e) {
			...
			if ( $(e.target).parents('.agreeCtr').is('.on') ) {
				...
				$(e.target).parents('.agreeCtr').next('.termCont','.termCont_rdo').find('input').removeAttr('checked');
...
function fnResize() {
	...
	$('.itemPack').each(function () {
		 ...
		 * 공통 기본형
		 */
		var liObj = $('.itemPack ul.itemListN1 > li:nth-child(1), .itemPack ul.itemListN2 > li:nth-child(1), .itemPack ul.itemListN2 > li:nth-child(2), .itemPack ul.itemListN3 > li:nth-child(1), .itemPack ul.itemListN3 > li:nth-child(2), .itemPack ul.itemListN3 > li:nth-child(3), .itemPack ul.itemListN4 > li:nth-child(1), .itemPack ul.itemListN4 > li:nth-child(2), .itemPack ul.itemListN4 > li:nth-child(3), .itemPack ul.itemListN4 > li:nth-child(4), .itemPack ul.itemListN5 > li:nth-child(1), .itemPack ul.itemListN5 > li:nth-child(2), .itemPack ul.itemListN5 > li:nth-child(3), .itemPack ul.itemListN5 > li:nth-child(4), .itemPack ul.itemListN5 > li:nth-child(5)');
...
$(document).ready(function () {
	...
	*/
	...
	$('header .btnMenuClose').on('click', function(){
		...
		$('.mainHeader > .btnAll').attr('aria-hidden' , false).css({'display':'block'});
...
$(document).ready(function() {	
	...
	$('.btnInfo').attr('title','입력정보 요약/변경페이지');
