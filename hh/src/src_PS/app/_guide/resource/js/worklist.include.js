...
function inc_linkInfo_ASIS(){
	var linkPath = '../../../app/_guide/';///@@@@@
	var psPath = '../../../src_PS/app/_guide/';///@@@@@
	var b2bPath = '../../../src_b2b/';
	var adminPath = '../../../src_admin/';
	var str='';
	str+='<table>';
	str+='<caption>Link info</caption>';
	str+='<colgroup>';
	...
	str+='		<td class="tobe_section">';
	str+='			<div>';
	str+='				<a href="'+linkPath+'worklist.html" class="btn aa01"><span>대표</span></a>';
	str+='				<a href="'+linkPath+'worklist.KC.html" class="btn aa02"><span>회사소개</span></a>';
	str+='				<a href="'+linkPath+'worklist.GC.html" class="btn aa03"><span>회사EN</span></a>';
	str+='				<a href="'+linkPath+'worklist.HP.html" class="btn aa04"><span>하이플래너</span></a>';
	str+='				<a href="'+linkPath+'worklist.DM.html" class="btn aa05"><span>직영</span></a>';
	str+='				<a href="'+psPath+'worklist.PS.html" class="btn bb04"><span>퇴직연금</span></a>';// else
	str+='			</div>';
	str+='		</td>';
	str+='	</tr>';
	...
	// str+='		<td class="tobe_section">';
	// str+='			<div>';
	// str+='				<a href="'+b2bPath+'index.BB.html" class="btn bb01"><span>B2B</span></a>';
	// str+='				<a href="'+b2bPath+'index.CG.html" class="btn bb02"><span>적하</span></a>';
	// str+='				<a href="'+b2bPath+'index.CE.html" class="btn bb03"><span>적하EN</span></a>';
	// str+='				<a href="'+b2bPath+'guide.html" class="btn b2b_guide_btn"><span>Guide</span></a>';
	// str+='				<a href="'+b2bPath+'todo.html" class="btn b2b_todo_btn"><span>Todo</span></a>';
	// str+='			</div>';
	// str+='		</td>';
	// str+='	</tr>';
	...
	// str+='		<td class="tobe_section">';
	// str+='			<div>';
	// str+='				<a href="'+adminPath+'index.HA.html" class="btn cc01"><span>대표</span></a>';
	// str+='				<a href="'+adminPath+'index.CA.html" class="btn cc02"><span>적하</span></a>';
	// str+='				<a href="'+adminPath+'index.BA.html" class="btn cc03"><span>B2B</span></a>';
	// str+='				<a href="'+linkPath+'worklist.HAMO.html" class="btn bb05"><span>장애대응</span></a>';// else
	// str+='				<a href="'+adminPath+'guide.html" class="btn admin_btn"><span>Guide</span></a>';
	// str+='				<a href="'+adminPath+'todo.html" class="btn admin_todo_btn"><span>Todo</span></a>';
	// str+='			</div>';
	// str+='		</td>';
	// str+='	</tr>';
	...
	str+='				<a href="'+linkPath+'worklist.todo.html" class="btn todo_btn"><span>Todo</span></a>';
	str+='				<a href="'+linkPath+'worklist.addon/data-converter/index.html" class="btn" target="_blank"><span>Data</span></a>';
	str+='				<a href="'+linkPath+'worklist.addon/url-encoder-SVG/index.html" class="btn" target="_blank"><span>Svg</span></a>';
	str+='				<a href="javascript:void(0);" class="log_btn btn"><span>Log</span></a>';
	str+='			</div>';
	str+='		</td>';
	str+='	</tr>';
